  ...
  <div>
    <div class="content">
      <div class="content__container">
        <p class="content__container__text">Olá</p>

        <ul class="content__container__list">
          <li class="content__container__list__item">Pessoal !</li>
          <li class="content__container__list__item">Draconatos !</li>
          <li class="content__container__list__item">Alienigenas !</li>
        </ul>
      </div>
    </div>
  </div>
